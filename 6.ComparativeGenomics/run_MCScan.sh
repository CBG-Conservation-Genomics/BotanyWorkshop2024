...
python -m jcvi.formats.fasta format Populus_deltoides_CDS.fasta Populus_deloides.cds
...
#do alignments
python -m jcvi.compara.catoalog ortholog Populus_deltoides Populus_trichocarpa --no_strip_names

#make synteny plot
python -m jcvi.graphics.dotplot Populus_deltoides.Populus_trichocarpa.anchors

#view macrosynteny
python -m jcvi.compara.synteny screen --minspan=30 --simple Populus_deltoides.Populus_trichocarpa.anchors grape.peach.anchors.new 
